...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  private void displayFrameworkBugMessageAndExit() {
    ...
    builder.setMessage("An error has occured while loading camera. Try restarting.");
    builder.setPositiveButton("Ȯ��", new FinishListener(this));
  ...
  private void resetStatusView() {
    ...
    statusView.setText("Place barcode over the square box");
